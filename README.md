...
at Ghana Communication Technology University/Computer Engineer/Level 100.
 
## What this program does
 
It counts down from 5 to 1 using a while loop. On each step:- It prints "Count: N" to the Serial Monitor.- It blinks  on-board LED N times using a function called flashLED().
...
Naabah Moise Fredericks — 2526400352.
